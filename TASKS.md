...
- [x] Проведена ревизия скриптов; реестр: `docs/script_registry.md` (`keep-prod`, `keep-manual`, `deprecate-candidate`)
- [x] Экспериментальный скрипт калибровки архивирован: `scripts/deprecated/calibrate_bug_duplicates.py`
